...
import { Gift, CornerDownRight, ExternalLink } from 'lucide-react';
import { motion, AnimatePresence } from 'motion/react';
import { UserInfo } from './types';
import FAQAccordion from './components/FAQAccordion';
import LeadForm from './components/LeadForm';
import DealsConsole from './components/DealsConsole';
import RewardSection from './components/RewardSection';
import { PandoraCrownO } from './components/PandoraLogo';

type FlowState = 'landing' | 'leads' | 'deals' | 'unlocked';
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#faf5f0] py-10 px-4 md:py-14 select-none relative overflow-x-hidden">
        ...
        >
          ...
          <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="space-y-4">
                  <button
                    ...
                    className="w-full bg-[#343538] hover:bg-[#1c1d21] hover:scale-[1.01] active:scale-[0.99] text-white font-extrabold py-4 px-8 rounded-full transition-all text-center tracking-wide text-lg shadow-md hover:shadow-lg cursor-pointer underline-none focus:outline-hidden"
                  >
                    CLAIM NOW
                  </button>
            ...
            {flowState === 'deals' && (
              <DealsConsole
                userInfo={userInfo}
                onAllCompleted={handleDealsCompleted}
              />
            )}
